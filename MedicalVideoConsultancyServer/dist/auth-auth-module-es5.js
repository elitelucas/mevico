...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["auth-auth-module"], {
  ...
  function srcAppPagesAuthSignInPatientSignInPatientComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function SignInPatientComponent_ng_container_3_Template(rf, ctx) {
      if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("hasError", function SignInPatientComponent_ng_container_3_Template_input_hasError_30_listener($event) {
          ...
          return ctx_r111.hasError($event);
          ...
          return ctx_r112.getNumber($event);
        })("intlTelInputObject", function SignInPatientComponent_ng_container_3_Template_input_intlTelInputObject_30_listener($event) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵrestoreView"](_r110);

          var ctx_r113 = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵnextContext"]();

          return ctx_r113.telInputObject($event);
        });
    ...
    /*#__PURE__*/
    function () {
      function SignInPatientComponent(formBuilder, authPatientService, router, patientService) {
        ...
        value: function checkRoom() {
          ...
          if (this.roomForm.valid) {
            ...
            this.authPatientService.joinValidatePatient(this.roomForm.value).subscribe(function (resultPatient) {
              ...
              _this.patientService.checkRoomExist(room).subscribe(function (result) {
                if (result) {
                  _this.step = 2;
          ...
          this.authPatientService.join(this.joinForm.value).subscribe(function (result) {
            if (result) {
              _this2.authPatientService.joinValidatePatient(result).subscribe(function (resultPatient) {
                ...
                _this2.patientService.checkRoomExist(room).subscribe(function (result) {
            ...
            if (error) {
              console.log("error");
              console.log(error); //if (error.error) error.error.errors[0].field === "dni" ? this.isDuplicatedDNI = true : (error.error.errors[0].field === 'phoneNumber' ? this.isDuplicatedPhone = true : this.isDuplicatedEmail = true);
            }
          });
        }
      }, {
  ...
  function srcAppPagesAuthSignInSignInComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function SignInComponent_div_16_div_3_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
  ...
  function srcAppPagesAuthSignUpSignUpComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    function SignUpComponent_ng_container_8_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementContainerStart"](0);
    ...
    function SignUpComponent_div_26_div_3_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function SignUpComponent_div_32_div_4_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function SignUpComponent_div_39_div_2_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function SignUpComponent_div_39_div_3_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function SignUpComponent_div_53_div_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function SignUpComponent_div_53_div_2_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function SignUpComponent_div_58_div_1_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function SignUpComponent_div_58_div_2_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div");
    ...
    function SignUpComponent_div_58_Template(rf, ctx) {
      if (rf & 1) {
        _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 33);
    ...
    /*#__PURE__*/
    function () {
      function SignUpComponent(formBuilder, auth) {
      ...
      _createClass(SignUpComponent, [{
        ...
        value: function onSubmit() {
          ...
          this.submitted = true;
          this.isEmptyPhoneNumber = !this.registerForm.value.phoneNumber; // stop here if form is invalid
          ...
          var dataNewUser = this.registerForm.value;
          dataNewUser['role'] = 'Dr';
          ...
          this.auth.signUp(this.registerForm.value).subscribe(function (res) {
            if (res.token) {
              ...
              _this6.isPending = true;
            } else if (res.status == "409") {
              res.errors[0].field == "room" ? _this6.isDuplicatedRoom = true : res.errors[0].field == 'phoneNumber' ? _this6.isDuplicatedPhone = true : _this6.isDuplicatedEmail = true;
            }
          });
        }
      }, {
        ...
        key: "telInputObject",
        value: function telInputObject(event) {
    ...
    SignUpComponent.ɵfac = function SignUpComponent_Factory(t) {
      return new (t || SignUpComponent)(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_angular_forms__WEBPACK_IMPORTED_MODULE_1__["FormBuilder"]), _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdirectiveInject"](_services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"]));
    };
    ...
    SignUpComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function SignUpComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngSubmit", function SignUpComponent_Template_form_ngSubmit_9_listener($event) {
            return ctx.onSubmit();
          });
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("hasError", function SignUpComponent_Template_input_hasError_44_listener($event) {
            return ctx.hasError($event);
          })("ng2TelOutput", function SignUpComponent_Template_input_ng2TelOutput_44_listener($event) {
            return ctx.getNumber($event);
          })("intlTelInputObject", function SignUpComponent_Template_input_intlTelInputObject_44_listener($event) {
            return ctx.telInputObject($event);
          })("countryChange", function SignUpComponent_Template_input_countryChange_44_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function SignUpComponent_Template_button_click_67_listener($event) {
            return ctx.onReset();
          });
